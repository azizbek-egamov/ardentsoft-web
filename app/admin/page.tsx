...
export default function AdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (credentials.username === "admin" && credentials.password === "ardentsoft2024") {
      ...
      <Card className="w-full max-w-md bg-white/95 backdrop-blur-xl border-0 shadow-2xl">
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-xl">
            <p className="text-sm text-blue-800 font-medium">Demo ma'lumotlar:</p>
            <p className="text-sm text-blue-600">Username: admin</p>
            <p className="text-sm text-blue-600">Password: ardentsoft2024</p>
          </div>
        </CardContent>
      </Card>
    </div>
