  ...
  const services = [
    {
      ...
      description: "Sun'iy intellekt va mashinani o'rganish texnologiyalari bilan kuchli yechimlar.",
    ...
    },
    {
      ...
      description: "Scalable va secure cloud yechimlar AWS, Azure va Google Cloud platformalarida.",
    ...
    },
    {
      ...
      description: "Native va cross-platform mobil ilovalar React Native va Flutter bilan.",
    ...
    },
    {
      ...
      description: "Modern web ilovalar Next.js, React va zamonaviy texnologiyalar bilan.",
    ...
    },
    {
      ...
      description: "Big Data, Analytics va real-time data processing yechimlar.",
    ...
    },
    {
      icon: <Shield className="w-6 h-6 sm:w-8 sm:h-8" />,
      title: "Cybersecurity",
      description: "Enterprise-level xavfsizlik va ma'lumotlarni himoya qilish yechimlar.",
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          <div className="bg-white/5 backdrop-blur-2xl rounded-3xl p-8 sm:p-12 md:p-16 lg:p-20 border border-white/10 shadow-2xl">
            ...
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full border border-white/20 mb-8">
              ...
              <span className="text-white font-semibold">Innovation IT Solutions</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="inline-flex items-center space-x-2 bg-blue-100 px-4 py-2 rounded-full mb-6">
                ...
                <span className="text-blue-600 font-semibold">Innovation Leaders</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-blue-200 mb-6">
              ...
              <span className="text-blue-600 font-semibold">Our Superpowers</span>
            </div>
      ...
      <section id="projects" className="py-20 sm:py-28 bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
        <div className="text-center mb-16 px-4">
          <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-blue-200 mb-6">
            ...
            <span className="text-blue-600 font-semibold">Our Projects</span>
          </div>
      ...
      <section className="py-20 sm:py-28 bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-blue-200 mb-6">
              <Users className="w-5 h-5 text-blue-600" />
              <span className="text-blue-600 font-semibold">Trusted Partners</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center space-x-2 bg-blue-100 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-blue-600 font-semibold">Client Reviews</span>
            </div>
